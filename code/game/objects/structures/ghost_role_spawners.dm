...
/obj/effect/mob_spawn/human/wendover
	name = "strange pod"
	uses = 1
	icon = 'icons/obj/machines/sleeper.dmi'
	icon_state = "sleeper"
...
/obj/effect/mob_spawn/human/wendover/special(mob/living/carbon/human/new_spawn)
	if(new_spawn.client)
		new_spawn.client.prefs.copy_to(new_spawn)
		var/datum/outfit/O = new /datum/outfit/wendover()
		O.equip(new_spawn, FALSE, new_spawn.client)
		SSjob.equip_loadout(null, new_spawn, FALSE)
		SSquirks.AssignQuirks(new_spawn, new_spawn.client, TRUE, TRUE, null, FALSE, new_spawn)

/datum/outfit/wendover
	name = "ID, jumpsuit and shoes"
	uniform = /obj/item/clothing/under/pants/f13/ghoul
	shoes = /obj/item/clothing/shoes/f13/raidertreads
