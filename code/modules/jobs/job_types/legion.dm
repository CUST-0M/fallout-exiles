...
/datum/outfit/job/CaesarsLegion/Legionnaire/f13centurion
	...
	mask = /obj/item/clothing/mask/f13/bandana/legion/legcenturion
	ears = /obj/item/radio/headset/headset_legion/cent
...
/datum/job/CaesarsLegion/Legionnaire/f13venator
	...
	total_positions = 1
	spawn_positions = 1
	description = "You are the Venator -- the Hunter. With your powerful rifle and your many years of experience, you are a formidable killing machine, capable of taking down even the most formidable profligates. Note that you are not a rank-and-file legionary, and you should not be operating as such -- your job is special operations, not fighting alongside the hordes of the Legion."
...
/datum/outfit/job/CaesarsLegion/Legionnaire/f13vexillarius
	...
	mask = /obj/item/clothing/mask/f13/bandana/legion/legvet
	neck = /obj/item/storage/belt/holster
...
/datum/outfit/job/CaesarsLegion/Legionnaire/f13legionary
	...
	id = /obj/item/card/id/dogtag/legprime
	mask = /obj/item/clothing/mask/f13/bandana/legion/legprime
...
/datum/outfit/job/CaesarsLegion/Legionnaire/f13recleg
	...
	mask = /obj/item/clothing/mask/f13/bandana/legion/legrecruit
	glasses = /obj/item/clothing/glasses/f13/legiongoggles
	r_pocket = /obj/item/flashlight/lantern
	backpack_contents = list(
		/obj/item/storage/bag/money/small/legenlisted = 1,
...
/datum/outfit/job/CaesarsLegion/Legionnaire/f13immune
	...
	mask = /obj/item/clothing/mask/f13/bandana/legion/camp
	uniform = /obj/item/clothing/under/f13/legskirt
	glasses = /obj/item/clothing/glasses/sunglasses
	shoes = /obj/item/clothing/shoes/f13/military/leather
	l_pocket = /obj/item/flashlight/lantern
