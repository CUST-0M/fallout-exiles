...
/obj/item/clothing/under/f13/ncr/desertfatigues
...
/obj/item/clothing/under/f13/countessdress
	name = "classy dress"
...
/obj/item/clothing/under/f13/khan/bearvest
	name = "great beat vest"
	desc = "Clothing marking the wearer as one of the the Great Khans. Most common are denim pants, but jorts is a acceptable alternative."
	icon = 'modular_exiles/icons/clothing/uniforms.dmi'
	mob_overlay_icon = 'modular_exiles/icons/mob/clothing/uniform.dmi'
	icon_state = "bear_vest"
	item_state = "bear_vest"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 10, "fire" = 10, "acid" = 40)
...
/obj/item/clothing/under/f13/tribal/shamanblue
...
/obj/item/clothing/under/f13/tribal/shamanred
...
/obj/item/clothing/under/f13/tribal/hunter
...
/obj/item/clothing/under/f13/whitelegsgarb
...
/obj/item/clothing/under/f13/whitelegsalt
	name = "White Legs garb"
	desc = "A segmented pair of dark leather shorts with an orange belt, paired with a distinct facewrap, worn by members of the White Legs tribe."
...
/obj/item/clothing/under/f13/female/whitelegsfalt
	name = "White Legs garb"
	desc = "A segmented pair of dark leather shorts with an orange belt and matching sports bra, paired with a distinct facewrap, worn by members of the White Legs tribe."
...
/obj/item/clothing/under/f13/exile/vault
	...
	desc = "A disheveled and torn uniform resembling a Vault-Tech standard Jumpsuit." //sprite needs update
...
/obj/item/clothing_item/under/f13/cowboyg
...
/obj/item/clothing/under/f13/drill_sarge
	...
	desc = "Best god damn uniform you have ever seen! so god dam good, uncle sam would cry."
