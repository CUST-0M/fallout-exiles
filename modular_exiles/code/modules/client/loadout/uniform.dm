...
/datum/gear/uniform/suit/bennys
	name = "white checkered Suit"
...
/datum/gear/uniform/lawyerblackalt
	name = "sleek black suit"
	path = /obj/item/clothing/under/suit/lawyerblackalt
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SUITS

/datum/gear/uniform/lawyerbluealt
	name = "sleek blue suit"
	path = /obj/item/clothing/under/suit/lawyerbluealt
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SUITS

/datum/gear/uniform/lawyerredalt
	name = "sleek red suit"
	path = /obj/item/clothing/under/suit/lawyerredalt
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SUITS

/datum/gear/uniform/redsuitalt
	name = "librarian suit"
	path = /obj/item/clothing/under/suit/redsuitalt
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SUITS

/datum/gear/uniform/reallyreallyblacksuit
	name = "relaxed black suit"
	path = /obj/item/clothing/under/suit/black_really_really
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SUITS
...
/datum/gear/uniform/dress/formalreddress
	name = "formal red dress"
	path = /obj/item/clothing/under/f13/formalreddress
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_DRESSES

/datum/gear/uniform/dress/cagedress
	name = "saloon dress"
	path = /obj/item/clothing/under/f13/cagedress
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_DRESSES
	cost = 2
...
/datum/gear/uniform/skirt/lawyerblackskirtalt
	name = "black suit skirt"
	path = /obj/item/clothing/under/suit/lawyerblackskirtalt
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SKIRTS
	cost = 2

/datum/gear/uniform/skirt/reallyreallyblackskirt
	name = "relaxed black suit skirt"
	path = /obj/item/clothing/under/suit/black_really_really_alt_skirtalt
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SKIRTS
	cost = 2

/datum/gear/uniform/skirt/lawyerblueskirtalt
	name = "blue suit skirt"
	path = /obj/item/clothing/under/suit/lawyerblueskirtalt
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SKIRTS
	cost = 2

/datum/gear/uniform/skirt/redsuitskirtalt
	name = "beige suit skirt"
	path = /obj/item/clothing/under/suit/redsuitskirtalt
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SKIRTS
	cost = 2

/datum/gear/uniform/skirt/lawyerredsuitskirtalt
	name = "red suit skirt"
	path = /obj/item/clothing/under/suit/lawyerredskirtalt
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SKIRTS
	cost = 2

/datum/gear/uniform/skirt/charcoalpencil
	name = "charcoal pencil skirt"
	path = /obj/item/clothing/under/suit/charcoalpencil
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SKIRTS
	cost = 2

/datum/gear/uniform/skirt/navypencil
	name = "navy pencil skirt"
	path = /obj/item/clothing/under/suit/navypencil
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SKIRTS
	cost = 2

/datum/gear/uniform/skirt/burgundypencil
	name = "burgundy pencil skirt"
	path = /obj/item/clothing/under/suit/burgundypencil
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SKIRTS
	cost = 2

/datum/gear/uniform/skirt/modeusformalwear
	name = "secretary suit skirt"
	path = /obj/item/clothing/under/suit/modeusformalwear
	subcategory = LOADOUT_SUBCATEGORY_UNIFORM_SKIRTS
	cost = 2
